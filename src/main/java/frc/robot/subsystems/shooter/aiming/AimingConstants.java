...
public class AimingConstants {
	...
	static {
		...
		REAL_MAP.put(3.49, new ShotSettings(Degrees.of(10), RotationsPerSecond.of(23.2)));
		REAL_MAP.put(3.98, new ShotSettings(Degrees.of(10.8), RotationsPerSecond.of(23.9)));
		REAL_MAP.put(4.28, new ShotSettings(Degrees.of(12.5), RotationsPerSecond.of(24.4)));
		REAL_MAP.put(4.74, new ShotSettings(Degrees.of(13), RotationsPerSecond.of(25.3)));
		REAL_MAP.put(5.07, new ShotSettings(Degrees.of(14.7), RotationsPerSecond.of(25.9)));
		REAL_MAP.put(5.73, new ShotSettings(Degrees.of(16), RotationsPerSecond.of(27)));
		REAL_MAP.put(7.00, new ShotSettings(Degrees.of(16), RotationsPerSecond.of(28.5)));
