...
public class AimingConstants {
	...
	static {
		...
		REAL_MAP.put(3.49, new ShotSettings(Degrees.of(10), RotationsPerSecond.of(24)));
		REAL_MAP.put(3.98, new ShotSettings(Degrees.of(10.8), RotationsPerSecond.of(25)));
		...
		REAL_MAP.put(5.4865, new ShotSettings(Degrees.of(20), RotationsPerSecond.of(28.25)));
		REAL_MAP.put(x, new ShotSettings(Degrees.of(x), RotationsPerSecond.of(x)));
		REAL_MAP.put(x, new ShotSettings(Degrees.of(x), RotationsPerSecond.of(x)));
		REAL_MAP.put(x, new ShotSettings(Degrees.of(x), RotationsPerSecond.of(x)));
		REAL_MAP.put(x, new ShotSettings(Degrees.of(x), RotationsPerSecond.of(x)));
