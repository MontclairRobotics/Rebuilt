...
public class AimingConstants {
	...
	static {
		...
		REAL_MAP.put(1.50, new ShotSettings(Degrees.of(0), RotationsPerSecond.of(20.4)));
		REAL_MAP.put(2.49, new ShotSettings(Degrees.of(9.5), RotationsPerSecond.of(22.3)));
		REAL_MAP.put(3.49, new ShotSettings(Degrees.of(10), RotationsPerSecond.of(23.8)));
		REAL_MAP.put(3.98, new ShotSettings(Degrees.of(10.8), RotationsPerSecond.of(24.4)));
		REAL_MAP.put(4.28, new ShotSettings(Degrees.of(12.5), RotationsPerSecond.of(25)));
		REAL_MAP.put(4.74, new ShotSettings(Degrees.of(13), RotationsPerSecond.of(26.1)));
		REAL_MAP.put(5.07, new ShotSettings(Degrees.of(14.7), RotationsPerSecond.of(26.7)));
		REAL_MAP.put(5.73, new ShotSettings(Degrees.of(16), RotationsPerSecond.of(27.7)));
		REAL_MAP.put(7.00, new ShotSettings(Degrees.of(16), RotationsPerSecond.of(29.2)));
