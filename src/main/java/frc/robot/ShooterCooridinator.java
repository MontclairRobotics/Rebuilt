...
public class ShooterCooridinator extends SubsystemBase{
  ...
  public void periodic() {
	...
	public ShooterCooridinator(CommandSwerveDrivetrain drivetrain, Intake intake, Shooter shooter, Vision vision) {
