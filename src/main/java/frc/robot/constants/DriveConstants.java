...
public class DriveConstants {
	...
	public static final LinearAcceleration MAX_ACCELERATION = MetersPerSecondPerSecond.of(6);
	...
	public static final AngularAcceleration MAX_ANGULAR_ACCELERATION = RotationsPerSecondPerSecond.of(2.0);
